...
await assertInvalidRecords([
  {
    ...
    prescriptionList: "注射用胰蛋白酶 规格5mg，每次5mg，静脉注射，每日1次，治疗期间复核，连续3天 + 达格列净片 规格10mg/片，每次10mg，口服，每日1次，早餐后服用，长期治疗 + 对乙酰氨基酚片 规格0.5g/片，每次0.25g，口服，每8小时1次，餐后服用，连续3天",
  },
  ...records.slice(1),
...
await assertInvalidRecords([
  {
    ...records[0],
    prescriptionList: records[0].prescriptionList.replace("疗程至术后4周", "疗程至术后4周；注意：术后用药阶段【阶梯启用：阶段一】"),
  },
  ...records.slice(1),
